...
* FiniteDifferenceCalculator: added new calculator (:mr:`3509`)
...
* Mixer: remove requirement that mixed calculators have common ``implemented_properties`` (:mr:`3480`)
...
* PythonSubProcessCalculator: Reduce verbosity (:mr:`3462`)
* Quantum Espresso
...
* Cleanup some "if True" / "if False" blocks  (:mr:`3457`, :mr:`3466`)
